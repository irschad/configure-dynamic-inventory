...
resource "aws_instance" "app-server-3" {
  ami           = data.aws_ami.latest-amazon-linux-image.id
  instance_type = var.instance_type
...
output "ec2-public_ip-server-1" {
  value = aws_instance.app-server-1.public_ip
}

output "ec2-public_ip-server-2" {
  value = aws_instance.app-server-2.public_ip
}

output "ec2-public_ip-server-3" {
  value = aws_instance.app-server-3.public_ip
}
